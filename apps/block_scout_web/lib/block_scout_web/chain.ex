defmodule BlockScoutWeb.Chain do
  ...
  defp paging_params(%StakingPool{staking_address_hash: address_hash, staked_ratio: value, position: pos}) do
    %{"address_hash" => address_hash, "value" => Decimal.to_string(value), "position" => pos}
  end
